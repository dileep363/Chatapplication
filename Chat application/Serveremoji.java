...
public class Serveremoji extends JFrame implements ActionListener
{
    ServerSocket server;
    Socket socket;
    String s="",name="",extra;
...
//to read the data from the client
    public void startReading()
    {
        ...
        while(true)
        {
            ...
            s = msg;
            //System.out.println("Client:>"+msg); --->to display in console
...
/*    public void startWriting()
    ...
    }*/ //to work in console we use start writing code
